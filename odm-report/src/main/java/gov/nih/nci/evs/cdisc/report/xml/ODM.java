 ...
 *         &lt;element ref="{http://www.w3.org/2000/09/xmldsig#}SignatureType" maxOccurs="unbounded" minOccurs="0"/>
...
public class ODM {
    ...
    @XmlElement(name = "SignatureType", namespace = "http://www.w3.org/2000/09/xmldsig#")
    protected List<SignatureType> signatureType;
    @XmlAttribute(name = "ControlledTerminologyVersion", namespace = "http://ncicb.nci.nih.gov/xml/odm/EVS/CDISC", required = true)
    protected String controlledTerminologyVersion;
    @XmlAttribute(name = "Context", namespace = "http://ncicb.nci.nih.gov/xml/odm/EVS/CDISC", required = true)
    protected ODMContext context;
    ...
    /**
     * Gets the value of the controlledTerminologyVersion property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getControlledTerminologyVersion() {
        if (controlledTerminologyVersion == null) {
            return "1.2.0";
        } else {
            return controlledTerminologyVersion;
        }
    }

    /**
     * Sets the value of the controlledTerminologyVersion property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setControlledTerminologyVersion(String value) {
        this.controlledTerminologyVersion = value;
    }
     ...
     *     
     */
    public void setContext(ODMContext value) {
        this.context = value;
    }
